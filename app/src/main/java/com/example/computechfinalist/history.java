...
public class history extends AppCompatActivity {
    private static final String URL_HIS = "http://192.168.1.113/computech/customer/display_history.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = findViewById(R.id.tvuname);
    ...
    private void loadHistory() {
        ...
        textView.setText(customuser);


        String url = URL_HIS + "?customuser=" + customuser;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            hisAdapter adapter = new hisAdapter(history.this, historyList);
