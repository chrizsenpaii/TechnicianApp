...
public class account_tech extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_account_tech);
        ...
        if (!usernamez.isEmpty()) {
            ...
            String url = "http://192.168.1.113/computech/technician/fetch_user_data.php?usernamez=" + usernamez;
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(account_tech.this,login.class);
        ...
        btnhistory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(account_tech.this,history.class);
                startActivity(intent);
            }
        });
    }
